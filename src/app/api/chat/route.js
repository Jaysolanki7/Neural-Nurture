...
CRITICAL INSTRUCTION: You MUST detect the language of the user's input (e.g., Hindi, English, etc.) and generate your ENTIRE JSON response (especially the 'assessment', 'likely_cause', 'specialist_needed' and 'home_care' fields) in that EXACT SAME language. If the user writes in Romanized Hindi (Hinglish), you should respond in Hinglish.
